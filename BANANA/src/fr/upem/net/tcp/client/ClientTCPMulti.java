...
public class ClientTCPMulti {
	 ...
	 * @throws IOException
	 */
	public ClientTCPMulti(String serverAdress, int serverPort)
						...
						switch(packet){
							...
							case ASC_CO_PRV_SC : 
								...
								if(map.get(name) == null){
									...
									System.out.println("Tapez /yes " + name + " pour accepter ou /no " 
											+ name +" pour refuser.");
								}
								else
	...
	private void treatCommand(String line) throws IOException{
		...
		if (line.startsWith("/")) {
			...
			if(argument.length >= 3){
				...
				System.out.println("Précisez un fichier à envoyer et la personne !\nExemple : /send monfichier Max");
			return;
