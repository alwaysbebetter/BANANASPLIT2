...
//					currentReader = new ReaderString(SRC_DATA);
			...
			//			readerASC_CO_PRV_CS = new ReaderString(new ReaderLong(new ReaderString(SRC_DATA)), DEST_DATA);
					}
		...
		public void dispatch() {
			...
			TypePacket typePacket =null ; //data.getTypePacket();
		/*	if (!isAnExpectedTypePacket(typePacket)) {
			}*/
			switch (typePacket) {
			case ASC_CO_SERV:
